...
public interface IndexClient {
     ...
     * インデックスを作成する。
     *
     * @param indexName        作成するインデックス名
     * @param numberOfShards   シャード数
     * @param numberOfReplicas レプリカ数
     * @param properties       フィールドマッピング定義（nullの場合はマッピングなし）
     * @param enableKnn        k-NN機能を有効にするかどうか
     * @return 作成が成功した場合 true
     * @throws IOException OpenSearch との通信エラーが発生した場合
     */
     ...
     * 既存インデックスのマッピングを更新する。
     *
     * @param indexName  更新するインデックス名
     * @param properties 追加するフィールドマッピング定義
     ...
     * @param indexPattern     適用対象のインデックスパターン
     * @param numberOfShards   シャード数
     * @param numberOfReplicas レプリカ数
     * @param properties       フィールドマッピング定義
     * @return 作成が成功した場合 true
     * @throws IOException OpenSearch との通信エラーが発生した場合
     */
    boolean putIndexTemplate(String templateName, String indexPattern,
     ...
     * インデックステンプレートを削除する。
     *
     * @param templateName 削除するテンプレート名
     * @return 削除が成功した場合 true
     * @throws IOException OpenSearch との通信エラーが発生した場合
     */
     ...
     * インデックスの設定を取得する。
     *
     * @param indexName 設定を取得するインデックス名
     ...
     * インデックスのマッピングを取得する。
     *
     * @param indexName マッピングを取得するインデックス名
     ...
     * インデックスをリフレッシュする。
     *
     * @param indexName リフレッシュするインデックス名
     * @throws IOException OpenSearch との通信エラーが発生した場合
     */
